...
//                new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.noproduct")).show(this);           
    ...
    private void incProduct(ProductInfoExt prod) {
        ...
        } else // Amended JG uniCenta Apr 14 Variable Price Product - Thanks Ron Isaacson
...
// JG May 2013 replaced with Multicatch            
    ...
    private void printReport(String resourcefile, TicketInfo ticket, Object ticketext, boolean externalResource) {
        ...
        try {
            ...
            InputStream in = null;
            if (externalResource) {
                String pathReports = m_App.getProperties().getProperty("home.app");
                pathReports = pathReports + resourcefile + ".jrxml";
                in = new FileInputStream(pathReports);
                JasperDesign jd = JRXmlLoader.load(in);
                jr = JasperCompileManager.compileReport(jd);
            } else {
                in = getClass().getResourceAsStream(resourcefile + ".ser");
                if (in == null) {
                    // read and compile the report
                    in = getClass().getResourceAsStream(resourcefile + ".jrxml");
                    JasperDesign jd = JRXmlLoader.load(in);
                    jr = JasperCompileManager.compileReport(jd);
                } else {
...
// remove all leading zeros from the string        
    ...
    public class ScriptObject {
        ...
        public void printReport(String resourcefile) {
            JPanelTicket.this.printReport(resourcefile, ticket, ticketext, false);
        }

        /**
         * Metodo para impirmir un reporte que puede ser externo al proyecto
         *
         * @param resourcefile
         * @param externalResource
         */
        public void printReport(String resourcefile, boolean externalResource) {
            JPanelTicket.this.printReport(resourcefile, ticket, ticketext, externalResource);
        }
